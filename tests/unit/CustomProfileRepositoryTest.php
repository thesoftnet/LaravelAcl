...
use TheSoftNet\LaravelAcl\Authentication\Models\ProfileField;
use TheSoftNet\LaravelAcl\Authentication\Models\ProfileFieldType;
...
class CustomProfileRepositoryTest extends DbTestCase {
    ...
    public function setUp()
    {
        ...
        $users = $this->times(2)->make('TheSoftNet\LaravelAcl\Authentication\Models\User',(function (){return $this->getUserStub();}));
        $this->user_1=  $users[0];
        $this->user_2=  $users[1];
