<?php namespace TheSoftNet\LaravelAcl\Library\Tests;

use TheSoftNet\LaravelAcl\Authentication\Tests\Unit\TestCase;
...
class FormModelTest extends TestCase
{
    ...
    /**
     * @expectedException \TheSoftNet\LaravelAcl\Library\Exceptions\ValidationException
     */
    ...
    /**
     * @expectedException \TheSoftNet\LaravelAcl\Library\Exceptions\NotFoundException
     */
    public function testProcessThrowNotFound()
    {
        $stub_validator = new ValidatorInterfaceStub();

        $mock_repo = m::mock('StdClass')->shouldReceive('update')->andThrow(new \TheSoftNet\LaravelAcl\Library\Exceptions\NotFoundException)->getMock();
        $form = new FormModel($stub_validator, $mock_repo);
        $form->process(array("id" => "1"));
    }
...
class ValidatorInterfaceStub implements \TheSoftNet\LaravelAcl\Library\Validators\ValidatorInterface
{
