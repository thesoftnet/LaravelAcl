<?php  namespace TheSoftNet\LaravelAcl\Authentication\Tests\Unit\Validators;

use Illuminate\Support\Facades\Event;
use TheSoftNet\LaravelAcl\Authentication\Tests\Unit\DbTestCase;
...
class UserValidatorTest extends DbTestCase  {
    ...
    {
        $user_created = $this->make('TheSoftNet\LaravelAcl\Authentication\Models\User', $this->getUserStub());
