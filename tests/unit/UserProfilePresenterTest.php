...
class UserProfilePresenterTest extends DbTestCase
{
    ...
    {
        $this->user = $this->initializeUserHasher()->make('TheSoftNet\LaravelAcl\Authentication\Models\User', $this->getUserStub())->first();
        $this->user_profile = $this->make('TheSoftNet\LaravelAcl\Authentication\Models\UserProfile', $this->getUserProfileStub($this->user))->first();
    }
