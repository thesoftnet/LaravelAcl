...
use App;
use Carbon\Carbon;
use TheSoftNet\LaravelAcl\Authentication\Repository\SentryUserRepository;
use TheSoftNet\LaravelAcl\Authentication\Repository\UserRepositorySearchFilter;
use TheSoftNet\LaravelAcl\Authentication\Tests\Unit\Traits\HourHelper;
use TheSoftNet\LaravelAcl\Authentication\Tests\Unit\Traits\UserFactory;
use Mockery as m;
...
class UserRepositorySearchFilterTest extends DbTestCase
{
    ...
    {
        $user_1 = $this->make('TheSoftNet\LaravelAcl\Authentication\Models\User', $this->getUserStub())->first();
        $user_profile_1 = $this->make('TheSoftNet\LaravelAcl\Authentication\Models\UserProfile', array_merge($this->getUserProfileStub($user_1),["first_name" => "1", "last_name" => "2"]) )->first();
        $user_2 = $this->make('TheSoftNet\LaravelAcl\Authentication\Models\User', $this->getUserStub())->first();
        $user_profile_2 = $this->make('TheSoftNet\LaravelAcl\Authentication\Models\UserProfile', array_merge($this->getUserProfileStub($user_2),["first_name" => "1", "last_name" => "1"]) )->first();
    ...
    {
        $this->times(2)->make('TheSoftNet\LaravelAcl\Authentication\Models\User', function(){return $this->getUserStub();});
