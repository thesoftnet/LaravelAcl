...
class EloquentUserProfileRepositoryTest extends DbTestCase
{
    ...
    {
        $users = $this->make('TheSoftNet\LaravelAcl\Authentication\Models\User', $this->getUserStub());
    ...
    /**
     * @test
     * @expectedException \TheSoftNet\LaravelAcl\Authentication\Exceptions\ProfileNotFoundException
     **/
    ...
    {
        $user = $this->make('TheSoftNet\LaravelAcl\Authentication\Models\User', $this->getUserStub())->first();
