...
use TheSoftNet\LaravelAcl\Authentication\Tests\Unit\Stubs\VoidRepository;
use TheSoftNet\LaravelAcl\Authentication\Tests\Unit\Stubs\VoidValidator;
...
class UserProfileServiceTest extends DbTestCase
{
    ...
    /**
     * @test
     * @expectedException \TheSoftNet\LaravelAcl\Library\Exceptions\InvalidException
     **/
    public function it_throw_exception_if_cannot_process()
    {
        $mock_form_profile = m::mock('TheSoftNet\LaravelAcl\Library\Form\FormModel');
    ...
    public function it_return_user_profile_if_success()
    {
        ...
        $this->assertInstanceOf('TheSoftNet\LaravelAcl\Authentication\Models\UserProfile', $profile);
    }
    ...
    public function it_check_for_permission_and_set_error_incase()
    {
        ...
        {
            $service->processForm(["user_id" => 1]);
        } catch(\TheSoftNet\LaravelAcl\Authentication\Exceptions\PermissionException $e)
        {
        }
    ...
    {
        $mock_form_profile_success = m::mock('TheSoftNet\LaravelAcl\Library\Form\FormModel')->shouldReceive('process')->andReturn($return)->getMock();
