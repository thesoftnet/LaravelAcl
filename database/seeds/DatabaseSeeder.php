<?php namespace TheSoftNet\LaravelAcl\Database;
...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
        ...
        $this->call('TheSoftNet\LaravelAcl\Database\PermissionSeeder');
        $this->call('TheSoftNet\LaravelAcl\Database\GroupsSeeder');
        $this->call('TheSoftNet\LaravelAcl\Database\UserSeeder');
