...
use Event;
use TheSoftNet\LaravelAcl\Library\Form\formInterface as FormInterface;

class FormModel implements FormInterface{

    /**
     * Validator
     * @var \TheSoftNet\LaravelAcl\Library\Validators\ValidatorInterface
     */
    protected $v;
    /**
     ...
     * @param $input
     * @throws \TheSoftNet\LaravelAcl\Library\Exceptions\NotFundException
     */
