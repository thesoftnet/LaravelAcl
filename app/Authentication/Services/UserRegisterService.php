<?php  namespace TheSoftNet\LaravelAcl\Authentication\Services;
...
use TheSoftNet\LaravelAcl\Authentication\Exceptions\TokenMismatchException;
...
use TheSoftNet\LaravelAcl\Authentication\Validators\UserSignupValidator;
...
{
    /**
     * @var \TheSoftNet\LaravelAcl\Authentication\Repository\Interfaces\UserRepositoryInterface
     */
    protected $user_repository;
    /**
     * @var \TheSoftNet\LaravelAcl\Authentication\Repository\Interfaces\UserProfileRepositoryInterface
     */
    protected $profile_repository;
    /**
     * @var \TheSoftNet\LaravelAcl\Authentication\Validators\UserSignupValidator
     */
    ...
    public function __construct(UserSignupValidator $v = null)
    {
        ...
        Event::listen('service.activated',
                      'TheSoftNet\LaravelAcl\Authentication\Services\UserRegisterService@sendActivationEmailToClient');
    }
    ...
    /**
     * @param array $input
     * @throws \TheSoftNet\LaravelAcl\Library\Exceptions\ValidationException
     */
    ...
    {
        $view_file = $this->activation_enabled ? "laravel-acl::admin.mail.registration-waiting-client" : "laravel-acl::admin.mail.registration-confirmed-client";
    ...
    public function sendActivationEmailToClient($user)
    {
        ...
        $mailer->sendTo($user->email, ["email" => $user->email],
                        ...
                        "laravel-acl::admin.mail.registration-activated-client");
    }

    /**
     * @param $email
     * @param $token
     * @throws \TheSoftNet\LaravelAcl\Authentication\Exceptions\UserNotFoundException
     * @throws \TheSoftNet\LaravelAcl\Authentication\Exceptions\TokenMismatchException
     */
