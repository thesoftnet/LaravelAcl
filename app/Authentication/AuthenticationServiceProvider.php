<?php namespace TheSoftNet\LaravelAcl\Authentication;

use App;
use TheSoftNet\LaravelAcl\Authentication\Classes\Captcha\GregWarCaptchaValidator;
use TheSoftNet\LaravelAcl\Authentication\Classes\CustomProfile\Repository\CustomProfileRepository;
use TheSoftNet\LaravelAcl\Authentication\Commands\InstallCommand;
use Config;
use TheSoftNet\LaravelAcl\Authentication\Helpers\FileRouteHelper;
use TheSoftNet\LaravelAcl\Authentication\Middleware\Config as ConfigMiddleware;
use Illuminate\Foundation\AliasLoader;
use Illuminate\Support\ServiceProvider;
use TheSoftNet\LaravelAcl\Authentication\Classes\SentryAuthenticator;
use TheSoftNet\LaravelAcl\Authentication\Helpers\SentryAuthenticationHelper;
use TheSoftNet\LaravelAcl\Authentication\Repository\EloquentPermissionRepository;
use TheSoftNet\LaravelAcl\Authentication\Repository\EloquentUserProfileRepository;
...
class AuthenticationServiceProvider extends ServiceProvider {
    ...
    protected $providers = [
            \TheSoftNet\LaravelAcl\Library\LibraryServiceProvider::class,
    ...
    protected function bindClasses()
    {
        ...
        $this->app->bind('TheSoftNet\LaravelAcl\Authentication\Interfaces\AuthenticateInterface', function ()
        {
