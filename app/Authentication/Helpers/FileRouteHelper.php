<?php  namespace TheSoftNet\LaravelAcl\Authentication\Helpers;
/**
...
use TheSoftNet\LaravelAcl\Library\Views\Helper as ViewHelper;
...
class FileRouteHelper implements AuthenticationRoutesInterface
{
     ...
     * @var string
     */
    protected $config_path = "acl_menu.list";
    /**
     * @var string
     */
