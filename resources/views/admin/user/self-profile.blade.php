            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        @if(! $use_gravatar)
                            @include('laravel-acl::admin.user.partials.avatar_upload')
                        @else
                            @include('laravel-acl::admin.user.partials.show_gravatar')
                        @endif
                    ...
                    <div class="col-md-6 col-xs-12">
                        ...
                        @if($can_add_fields)
                        @include('laravel-acl::admin.user.custom-profile')
                        @endif
